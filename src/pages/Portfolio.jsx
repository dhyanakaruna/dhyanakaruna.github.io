        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {projects.map((project, index) => (
              ...
              >
                <div className="w-full h-40 sm:h-48 bg-gradient-to-br from-burgundy-100 to-maroon-100 rounded-lg mb-4 flex items-center justify-center border border-burgundy-200">
